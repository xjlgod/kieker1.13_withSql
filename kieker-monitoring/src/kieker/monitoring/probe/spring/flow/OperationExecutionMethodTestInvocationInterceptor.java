 ...
 * @since 1.8
 */
public class OperationExecutionMethodTestInvocationInterceptor implements MethodInterceptor, IMonitoringProbe {
	...
	public OperationExecutionMethodTestInvocationInterceptor() {
	 ...
	 *            must not be null
	 */
	public OperationExecutionMethodTestInvocationInterceptor(final IMonitoringController monitoringController) {
